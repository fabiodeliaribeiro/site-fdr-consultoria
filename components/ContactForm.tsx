...
const ContactForm: React.FC<ContactFormProps> = ({ initialMessage = '' }) => {
  ...
  return (
    <section id="contato" className="py-16 bg-background-light dark:bg-background-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-surface-dark rounded-[40px] shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800">
          <div className="grid md:grid-cols-12 min-h-[500px]">
            {/* Sidebar */}
            <div className="md:col-span-5 bg-primary p-8 lg:p-12 text-white flex flex-col justify-between relative overflow-hidden">
              ...
              {isSuccess ? (
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-widest" htmlFor="name">Nome Completo</label>
                      <input
                        required
                        className="w-full h-12 px-4 rounded-xl border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-background-dark text-gray-900 dark:text-white focus:ring-primary focus:border-primary transition-all"
                        id="name"
                    ...
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-widest" htmlFor="email">Email Corporativo</label>
                      <input
                        required
                        className="w-full h-12 px-4 rounded-xl border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-background-dark text-gray-900 dark:text-white focus:ring-primary focus:border-primary transition-all"
                        id="email"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-widest" htmlFor="segments">Segmento da Empresa</label>
                    <select
                      className="w-full h-12 px-4 rounded-xl border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-background-dark text-gray-900 dark:text-white focus:ring-primary focus:border-primary transition-all"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-widest" htmlFor="message">Como podemos ajudar?</label>
                    <textarea
                      className="w-full px-4 py-3 rounded-xl border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-background-dark text-gray-900 dark:text-white focus:ring-primary focus:border-primary transition-all min-h-[100px]"
                      id="message"
                  ...
                  <button
                    ...
                    className={`w-full py-4 font-bold text-lg rounded-2xl transition-all shadow-xl hover:-translate-y-1 flex items-center justify-center gap-3 ${isSubmitting
